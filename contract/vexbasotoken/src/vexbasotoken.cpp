#include "vexbasotoken.hpp"
#include "eosio.token.cpp"

using eosio::check;

namespace vexbaso {
    void vexbasotoken::destroy(eosio::name issuer,
    ...
    void vexbasotoken::addsupply(eosio::asset addsupply) {
        require_auth(_self);
    ...
    void vexbasotoken::subsupply(eosio::asset subsupply) {
        require_auth(_self);
    ...
    void vexbasotoken::retire(eosio::name from,
    ...
    void vexbasotoken::pause(eosio::symbol symbol) {
        require_auth(_self);
    ...
    void vexbasotoken::unpause(eosio::symbol symbol) {
        require_auth(_self);
    ...
    void vexbasotoken::freeze(eosio::name owner) {
        require_auth(_self);
    ...
    void vexbasotoken::unfreeze(eosio::name owner) {
        require_auth(_self);
...
EOSIO_DISPATCH(vexbaso::vexbasotoken,
(create)(open)(close)(issue)(transfer)(retire)(destroy)(addsupply)(subsupply)(pause)(unpause)(freeze)(unfreeze)
)
